...
//--------------------------------------------------------------------------------------------------------
// <auto-generated>
//     This C# code class was auto-generated at 01/13/2021 21:31:57.
...
namespace Matroska
{
    ...
    internal static class MatroskaSpecification
    {
        ...
        public const ulong SignatureElements = 0x7E5B;
        public static readonly ElementDescriptor SignatureElementsDescriptor = new ElementDescriptor(SignatureElements, nameof(SignatureElements), ElementType.MasterElement);
        ...
        public const ulong SignatureElementList = 0x7E7B;
        public static readonly ElementDescriptor SignatureElementListDescriptor = new ElementDescriptor(SignatureElementList, nameof(SignatureElementList), ElementType.MasterElement);

        /// <summary>An element ID whose data will be used to compute the signature.</summary>
        public const ulong SignedElement = 0x6532;
        public static readonly ElementDescriptor SignedElementDescriptor = new ElementDescriptor(SignedElement, nameof(SignedElement), ElementType.Binary);

        /// <summary>Contain signature of some (coming) elements in the stream.</summary>
        public const ulong SignatureSlot = 0x1B538667;
        public static readonly ElementDescriptor SignatureSlotDescriptor = new ElementDescriptor(SignatureSlot, nameof(SignatureSlot), ElementType.MasterElement);

        /// <summary>The signature of the data (until a new.</summary>
        public const ulong Signature = 0x7EB5;
        public static readonly ElementDescriptor SignatureDescriptor = new ElementDescriptor(Signature, nameof(Signature), ElementType.Binary);

        /// <summary>Signature algorithm used (1=RSA, 2=elliptic).</summary>
        public const ulong SignatureAlgo = 0x7E8A;
        public static readonly ElementDescriptor SignatureAlgoDescriptor = new ElementDescriptor(SignatureAlgo, nameof(SignatureAlgo), ElementType.UnsignedInteger);

        /// <summary>Hash algorithm used (1=SHA1-160, 2=MD5).</summary>
        public const ulong SignatureHash = 0x7E9A;
        public static readonly ElementDescriptor SignatureHashDescriptor = new ElementDescriptor(SignatureHash, nameof(SignatureHash), ElementType.UnsignedInteger);

        /// <summary>The public key to use with the algorithm (in the case of a PKI-based signature).</summary>
        public const ulong SignaturePublicKey = 0x7EA5;
        public static readonly ElementDescriptor SignaturePublicKeyDescriptor = new ElementDescriptor(SignaturePublicKey, nameof(SignaturePublicKey), ElementType.Binary);
        ...
        public static readonly ElementDescriptor FileMimeTypeDescriptor = new ElementDescriptor(FileMimeType, nameof(FileMimeType), ElementType.AsciiString);
        ...
        public static readonly ElementDescriptor ChapLanguageIETFDescriptor = new ElementDescriptor(ChapLanguageIETF, nameof(ChapLanguageIETF), ElementType.AsciiString);
        ...
        public static readonly ElementDescriptor ChapterSegmentUIDDescriptor = new ElementDescriptor(ChapterSegmentUID, nameof(ChapterSegmentUID), ElementType.Binary);
        ...
        public static readonly ElementDescriptor NextUIDDescriptor = new ElementDescriptor(NextUID, nameof(NextUID), ElementType.Binary);
        ...
        public static readonly ElementDescriptor PrevUIDDescriptor = new ElementDescriptor(PrevUID, nameof(PrevUID), ElementType.Binary);
        ...
        public static readonly ElementDescriptor SegmentUIDDescriptor = new ElementDescriptor(SegmentUID, nameof(SegmentUID), ElementType.Binary);
        ...
        public static readonly ElementDescriptor TagLanguageIETFDescriptor = new ElementDescriptor(TagLanguageIETF, nameof(TagLanguageIETF), ElementType.AsciiString);
        ...
        public static readonly ElementDescriptor LanguageIETFDescriptor = new ElementDescriptor(LanguageIETF, nameof(LanguageIETF), ElementType.AsciiString);
        ...
        public static readonly ElementDescriptor ColourSpaceDescriptor = new ElementDescriptor(ColourSpace, nameof(ColourSpace), ElementType.Binary);
