...
//--------------------------------------------------------------------------------------------------------
// <auto-generated>
//     This C# code class was auto-generated at 01/13/2021 17:03:41.
...
namespace Matroska.Models
{
    ...
    public sealed class EBML : BaseModel
    {
        ...
        [MatroskaElementDescriptor(MatroskaSpecification.SignatureElements)]
        public SignatureElements? SignatureElements { get; set; }

        [MatroskaElementDescriptor(MatroskaSpecification.SignatureSlot, typeof(SignatureSlot))]
        public List<SignatureSlot>? SignatureSlots { get; set; }
    }

    [GeneratedCode("MatroskaModels.tt", "1.0.0.0")]
    public sealed class SignatureElements : BaseModel
    {
        [MatroskaElementDescriptor(MatroskaSpecification.SignatureElementList, typeof(SignatureElementList))]
        public List<SignatureElementList>? SignatureElementLists { get; set; }
    }

    [GeneratedCode("MatroskaModels.tt", "1.0.0.0")]
    public sealed class SignatureElementList : BaseModel
    {
        [MatroskaElementDescriptor(MatroskaSpecification.SignedElement)]
        public List<byte[]>? SignedElements { get; set; }
    }

    [GeneratedCode("MatroskaModels.tt", "1.0.0.0")]
    public sealed class SignatureSlot : BaseModel
    {
        [MatroskaElementDescriptor(MatroskaSpecification.Signature)]
        public byte[]? Signature { get; set; }

        [MatroskaElementDescriptor(MatroskaSpecification.SignatureAlgo)]
        public ulong? SignatureAlgo { get; set; }

        [MatroskaElementDescriptor(MatroskaSpecification.SignatureHash)]
        public ulong? SignatureHash { get; set; }

        [MatroskaElementDescriptor(MatroskaSpecification.SignaturePublicKey)]
